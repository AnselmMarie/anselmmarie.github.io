...
`libs/features/footer/src/footer.tsx` with the real footer. Everything *around*
...
- `libs/features/footer/src/footer.tsx` — the real component, in place of the placeholder.
